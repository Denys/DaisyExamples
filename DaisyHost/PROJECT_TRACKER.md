...
- `cmd /c build_host.cmd`: passed on 2026-04-27
- underlying aggregate:
  ...
  - `ctest --test-dir build -C Release --output-on-failure`: passed, `233/233`
