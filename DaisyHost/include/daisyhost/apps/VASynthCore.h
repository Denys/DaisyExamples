...
namespace apps
{
class VASynthCore : public HostedAppCore
{
  public:
    static constexpr std::size_t kPreferredBlockSize
        = DaisyVASynthCore::kPreferredBlockSize;

    explicit VASynthCore(const std::string& nodeId = "node0");
