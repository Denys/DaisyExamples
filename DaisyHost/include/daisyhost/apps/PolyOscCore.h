...
namespace apps
{
class PolyOscCore : public HostedAppCore
{
  public:
    static constexpr std::size_t kPreferredBlockSize
        = DaisyPolyOscCore::kPreferredBlockSize;

    explicit PolyOscCore(const std::string& nodeId = "node0");
