...
namespace apps
{
class HarmoniqsCore : public HostedAppCore
{
  public:
    static constexpr std::size_t kPreferredBlockSize
        = DaisyHarmoniqsCore::kPreferredBlockSize;

    explicit HarmoniqsCore(const std::string& nodeId = "node0");
  ...
  private:
    ...
    std::string                                nodeId_;
    DaisyHarmoniqsCore                         sharedCore_;
