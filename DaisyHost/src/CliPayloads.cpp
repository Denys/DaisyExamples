...
namespace cli
{
    namespace
    {
        ...
        const HostedAppRegistration*
        FindAppRegistration(const std::string& appId)
        {
            const auto& registrations = GetHostedAppRegistrations();
        ...
        juce::Array<juce::var>
        StringArrayVar(const std::array<std::string, 2>& values)
        {
        ...
        juce::Array<juce::var>
        StringArrayVar(const std::array<std::string, Size>& values)
        {
            juce::Array<juce::var> array;
            for(const auto& value : values)
            {
        ...
        {
            auto object = std::make_unique<juce::DynamicObject>();
            object->setProperty("acceptsAudioInput",
                                capabilities.acceptsAudioInput);
            object->setProperty("acceptsMidiInput",
                                capabilities.acceptsMidiInput);
            object->setProperty("producesMidiOutput",
                                capabilities.producesMidiOutput);
            return juce::var(object.release());
        }
        ...
        juce::var PatchBindingsVar(const HostedAppPatchBindings& bindings)
        {
            ...
            object->setProperty("gateOutputPortId",
                                StringVar(bindings.gateOutputPortId));
            object->setProperty(
                "audioInputPortIds",
            ...
            object->setProperty("midiInputPortId",
                                StringVar(bindings.midiInputPortId));
            object->setProperty("midiOutputPortId",
                                StringVar(bindings.midiOutputPortId));
            return juce::var(object.release());
        }
        ...
        juce::var ParameterVar(const ParameterDescriptor& parameter)
        {
            ...
            object->setProperty("role",
                                StringVar(ParameterRoleName(parameter.role)));
        ...
        juce::var MenuItemVar(const MenuItem& item)
        {
            ...
            object->setProperty("actionKind",
                                StringVar(MenuActionKindName(item.actionKind)));
            object->setProperty("normalizedValue", item.normalizedValue);
            object->setProperty("valueText", StringVar(item.valueText));
            object->setProperty("targetSectionId",
                                StringVar(item.targetSectionId));
            return juce::var(object.release());
        }
        ...
        juce::var VirtualPortVar(const VirtualPort& port)
        {
            ...
            object->setProperty("type",
                                StringVar(VirtualPortTypeName(port.type)));
            object->setProperty("direction",
                                StringVar(PortDirectionName(port.direction)));
        ...
        juce::var ControlSpecVar(const ControlSpec& control)
        {
            ...
            object->setProperty("kind",
                                StringVar(ControlKindName(control.kind)));
        ...
        juce::var DecorationVar(const PanelDecorationSpec& decoration)
        {
            ...
            object->setProperty("kind",
                                StringVar(DecorationKindName(decoration.kind)));
        ...
        juce::var TextVar(const PanelTextSpec& text)
        {
            ...
            object->setProperty("alignment",
                                StringVar(TextAlignmentName(text.alignment)));
            return juce::var(object.release());
        }
        ...
        juce::var IndicatorVar(const PanelIndicatorSpec& indicator)
        {
            ...
            object->setProperty("kind",
                                StringVar(IndicatorKindName(indicator.kind)));
            object->setProperty("panelBounds", RectVar(indicator.panelBounds));
            return juce::var(object.release());
        }

        template <typename Item, typename Mapper>
        juce::Array<juce::var> VectorVar(const std::vector<Item>& values,
                                         Mapper                   mapper)
        {
            juce::Array<juce::var> array;
            for(const auto& value : values)
        ...
        juce::var RenderFloatMapVar(const std::map<std::string, float>& values)
        {
            ...
            {
                object->setProperty(juce::Identifier(entry.first),
                                    entry.second);
            }
            return juce::var(object.release());
        }
        ...
        juce::var RenderNodeSummaryVar(const RenderNodeResultSummary& node)
        {
            ...
            object->setProperty("appDisplayName",
                                StringVar(node.appDisplayName));
            ...
            object->setProperty(
                "finalEffectiveParameterValues",
                RenderFloatMapVar(node.finalEffectiveParameterValues));
            object->setProperty("finalCvInputs",
                                RenderFloatMapVar(node.finalCvInputs));
            object->setProperty("finalGateInputs",
                                RenderBoolMapVar(node.finalGateInputs));
            return juce::var(object.release());
        }
        ...
        juce::var RenderDebugTimelineEventVar(const RenderTimelineEvent& event)
        {
            ...
            object->setProperty(
                "type", StringVar(GetRenderTimelineEventTypeName(event.type)));
            object->setProperty(
                "scope",
                StringVar(event.targetNodeId.empty() ? "global" : "node"));
            object->setProperty("resolution",
                                StringVar(DebugEventResolution(event)));
            if(!event.targetNodeId.empty())
            {
                object->setProperty("targetNodeId",
                                    StringVar(event.targetNodeId));
            }

            switch(event.type)
            {
                case RenderTimelineEventType::kParameterSet:
                    object->setProperty("parameterId",
                                        StringVar(event.parameterId));
                    object->setProperty("normalizedValue",
                ...
                case RenderTimelineEventType::kMidi:
                    object->setProperty(
                        "status", static_cast<int>(event.midiMessage.status));
                    object->setProperty(
                        "data1", static_cast<int>(event.midiMessage.data1));
                    object->setProperty(
                        "data2", static_cast<int>(event.midiMessage.data2));
                    break;
                case RenderTimelineEventType::kAudioInputConfig:
                    if(event.hasAudioMode)
                    {
                        object->setProperty(
                            "mode",
                            StringVar(
                                GetRenderAudioInputModeName(event.audioMode)));
                    }
                    ...
                    {
                        object->setProperty("frequencyHz",
                ...
                case RenderTimelineEventType::kMenuSetItem:
                    object->setProperty("menuItemId",
                                        StringVar(event.menuItemId));
                    object->setProperty("normalizedValue",
                                        event.normalizedValue);
                    break;
                case RenderTimelineEventType::kSurfaceControlSet:
                    object->setProperty("controlId",
                                        StringVar(event.controlId));
                    object->setProperty("normalizedValue",
                                        event.normalizedValue);
                    break;
            }
        ...
        juce::var RenderDebugStateVar(const RenderResultManifest& manifest)
        {
            ...
            root->setProperty("selectedNodeId",
                              StringVar(manifest.selectedNodeId));
            ...
            timeline->setProperty("resolvedTargetEventCount",
                                  resolvedTargetEventCount);
            timeline->setProperty(
                "events",
            ...
            {
                eventCounts->setProperty(juce::Identifier(entry.first),
                                         entry.second);
            }
        ...
        juce::var RenderAssertionReportVar(const RenderAssertionReport& report)
        {
            ...
            object->setProperty(
                "results",
                juce::var(VectorVar(report.results, RenderAssertionResultVar)));
            return juce::var(object.release());
        }

        juce::var
        AutomationSlotVar(const EffectiveHostAutomationSlotSnapshot& slot)
        {
            auto object = std::make_unique<juce::DynamicObject>();
            ...
            object->setProperty("parameterLabel",
                                StringVar(slot.parameterLabel));
        ...
        std::string
        DebugRoleLabel(bool selected, bool entryNode, bool outputNode)
        {
            std::string role;
        ...
        {
            auto object = std::make_unique<juce::DynamicObject>();
            object->setProperty("liveControlsTargetNodeId",
                                StringVar(selectedNodeId));
            object->setProperty("cvGateTargetNodeId",
                                StringVar(selectedNodeId));
            object->setProperty("modulationTargetNodeId",
                                StringVar(selectedNodeId));
            object->setProperty("fieldSurfaceTargetNodeId",
                                StringVar(selectedNodeId));
        ...
        juce::var
        SnapshotDebugStateVar(const EffectiveHostStateSnapshot& snapshot)
        {
            auto root = std::make_unique<juce::DynamicObject>();
            root->setProperty("boardId", StringVar(snapshot.boardId));
            root->setProperty("selectedNodeId",
                              StringVar(snapshot.selectedNodeId));
            ...
            root->setProperty("routes",
                              juce::var(VectorVar(snapshot.routes, RouteVar)));
            root->setProperty("controlTargets",
        ...
        juce::var
        ModulationLaneVar(const EffectiveHostModulationLaneSnapshot& lane)
        {
            auto object = std::make_unique<juce::DynamicObject>();
            object->setProperty("slotIndex", lane.slotIndex);
            object->setProperty("enabled", lane.enabled);
            object->setProperty(
                "source", StringVar(HostModulationSourceToString(lane.source)));
            ...
            const EffectiveHostModulationDestinationSnapshot& destination)
        {
            ...
            object->setProperty("parameterId",
                                StringVar(destination.parameterId));
            object->setProperty("parameterLabel",
                                StringVar(destination.parameterLabel));
            ...
            object->setProperty("resultNativeValue",
                                destination.resultNativeValue);
            object->setProperty("resultNormalizedValue",
                                destination.resultNormalizedValue);
            object->setProperty("clamped", destination.clamped);
            object->setProperty(
                "lanes",
                juce::var(VectorVar(destination.lanes, ModulationLaneVar)));
            return juce::var(object.release());
        }

        juce::var
        FieldSurfaceVar(const EffectiveHostFieldSurfaceSnapshot& surface)
        {
            auto object = std::make_unique<juce::DynamicObject>();
        ...
        BuildDefaultFieldSurface(HostedAppCore& app, const std::string& nodeId)
        {
            EffectiveHostFieldSurfaceSnapshot snapshot;
            const auto                        mapping
                = BuildDaisyFieldControlMapping(app.GetPatchBindings(),
                                                app.GetParameters(),
                                                app.GetMenuModel(),
                                                4,
                                                nodeId);

            for(std::size_t index = 0; index < mapping.cvOutputs.size();
                ++index)
            {
    ...
    std::string SerializeAppsPayloadJson()
    {
        ...
        for(const auto& registration : GetHostedAppRegistrations())
        {
            ...
            item->setProperty("displayName",
                              StringVar(registration.displayName));
                                            ...
                                            std::string*       errorMessage)
    {
        ...
        root->setProperty("capabilities",
                          CapabilitiesVar(app->GetCapabilities()));
        root->setProperty("patchBindings",
                          PatchBindingsVar(app->GetPatchBindings()));
        ...
        menuObject->setProperty("currentSectionId",
                                StringVar(menu.currentSectionId));
                                              ...
                                              std::string*       errorMessage)
    {
        ...
        root->setProperty(
            "surfaceControls",
            juce::var(VectorVar(profile->surfaceControls, SurfaceControlVar)));
        root->setProperty(
            "decorations",
            juce::var(VectorVar(profile->decorations, DecorationVar)));
        root->setProperty("texts",
                          juce::var(VectorVar(profile->texts, TextVar)));
        root->setProperty(
            "indicators",
    ...
    std::string
    SerializeRenderResultPayloadJson(const RenderResultManifest&  manifest,
                                     const RenderAssertionReport* assertions)
    {
        ...
        root->setProperty(
            "channelSummaries",
            juce::var(VectorVar(manifest.channelSummaries, ChannelSummaryVar)));
        root->setProperty(
            "nodes",
            juce::var(VectorVar(manifest.nodes, RenderNodeSummaryVar)));
        root->setProperty(
            "routes", juce::var(VectorVar(manifest.routes, RenderRouteVar)));
        ...
        {
            root->setProperty("assertions",
                              RenderAssertionReportVar(*assertions));
        }
        return ToJson(juce::var(root.release()));
    }
                              ...
                              std::string*                errorMessage)
    {
        ...
        const auto automationSlots
            = BuildHostAutomationSlotBindings(parameters);
    ...
    std::string
    SerializeSnapshotPayloadJson(const EffectiveHostStateSnapshot& snapshot)
    {
        auto root = std::make_unique<juce::DynamicObject>();
        root->setProperty("boardId", StringVar(snapshot.boardId));
        ...
        root->setProperty(
            "nodeSummaries",
            juce::var(VectorVar(snapshot.nodeSummaries, NodeSummaryVar)));
        root->setProperty("routes",
                          juce::var(VectorVar(snapshot.routes, RouteVar)));
        root->setProperty(
            "parameters",
        ...
        root->setProperty("metaControllers",
                          juce::var(VectorVar(
                              snapshot.metaControllers,
                              [](const EffectiveHostMetaControllerSnapshot& c) {
                                  return MetaControllerVar(
                                      {c.id,
                                       c.label,
                                       c.normalizedValue,
        ...
        root->setProperty("fieldSurface",
                          FieldSurfaceVar(snapshot.fieldSurface));
