...
flowchart LR
    ...
    style OSC fill:#24911c,stroke:#4a8c28
    style FILT fill:#529ad1,stroke:#2d7ab8
    style ENV fill:#cf8032,stroke:#8c5a2d
    style FX fill:#d13689,stroke:#7a2d7a
...
flowchart TD
    ...
    style START fill:#24911c,stroke:#2d8c2d
    style UPDATE fill:#529ad1,stroke:#2d7ab8
    style DISPLAY fill:#cf8032,stroke:#8c5a2d
```
