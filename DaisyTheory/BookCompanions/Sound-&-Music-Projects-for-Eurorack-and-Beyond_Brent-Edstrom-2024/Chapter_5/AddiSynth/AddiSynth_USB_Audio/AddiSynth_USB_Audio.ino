/*
  ...
  Description: 
  Additive synthesizer for Teensy 4 with USB Audio.
...
AudioSynthWaveformSine   sine1;          //xy=88.19999694824219,46.19999694824219
AudioSynthWaveformSine   sine2;          //xy=88.19999694824219,156.1999969482422
AudioSynthWaveform       waveform2;      //xy=88.19999694824219,205.1999969482422
AudioSynthWaveformSine   sine3;          //xy=88.19999694824219,277.1999969482422
AudioSynthWaveform       waveform3;      //xy=88.19999694824219,326.1999969482422
AudioSynthWaveform       waveform1;      //xy=89.19999694824219,94.19999694824219
AudioSynthWaveformSine   sine4;          //xy=88.19999694824219,397.1999969482422
AudioSynthWaveform       waveform4;      //xy=88.19999694824219,456.1999969482422
AudioEffectMultiply      multiply1;      //xy=252.1999969482422,59.19999694824219
AudioEffectMultiply      multiply4;      //xy=253.1999969482422,406.1999969482422
AudioEffectMultiply      multiply2;      //xy=257.1999969482422,165.1999969482422
AudioEffectMultiply      multiply3;      //xy=259.1999969482422,286.1999969482422
AudioMixer4              mixer1;         //xy=522.1999969482422,125.19999694824219
AudioEffectEnvelope      envelope1;      //xy=712.1999969482422,109.19999694824219
AudioOutputUSB           usb1;           //xy=894.1999969482422,99.19999694824219
...
AudioConnection          patchCord14(envelope1, 0, usb1, 0);
AudioConnection          patchCord15(envelope1, 0, usb1, 1);
AudioControlSGTL5000     sgtl5000_1;     //xy=869.1999969482422,222.1999969482422
...
//Create an array to store the harmonics
...
void setup() 
{
  ...
  //Call helper functions to set up harmonics and audio pointers  
  setAudioPointers();
  initializeHarmonics();
  updateHarmonics();
