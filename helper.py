...
usage = {
    ...
    'board': 'optional argument for selecting the template when using the create operation. Default is seed. Options are: seed, field, patch, petal, pedal, pod, versio, legio, patch_sm',
...
supported_boards = ['seed', 'pod', 'patch',
    'field', 'petal', 'pedal', 'versio', 'legio', 'patch_sm']
